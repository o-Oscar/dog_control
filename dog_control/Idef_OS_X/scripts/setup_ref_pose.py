...
if __name__ == "__main__":
	...
	input("Put motors {} in their rest position and then press enter.".format(motor_ids))
	for motor_id in motor_ids:
	...
	input("Put motors {} in their zero position and then press enter.".format(motor_ids))
	for motor_id in motor_ids:
		current_pos = bus.get_actuator_pos(motor_id)
